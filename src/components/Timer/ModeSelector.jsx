...
const modeList = [
  ...
  { id: 'pomodoro-50', label: 'Pomodoro 50 min', group: 'Pomodoro' },
  { id: 'break-5',    label: 'Pausa 5 min',      group: 'Pausa' },
  { id: 'break-10',   label: 'Pausa 10 min',     group: 'Pausa' },
  { id: 'break-30',   label: 'Pausa 30 min',     group: 'Pausa' },
  { id: 'custom',     label: 'Personalizado',    group: 'Outro' },
