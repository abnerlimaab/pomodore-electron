...
export default function ActivitiesPage() {
  ...
  const typedGrupos = grupos as Tema[];
  ...
  const filteredAtividades = selectedGrupo
    ? typedAtividades.filter(a => a.tema_id === selectedGrupo.id)
    : typedAtividades;
        ...
        <List sx={{ overflow: 'auto', flex: 1, py: 1 }}>
          <ListItem disablePadding>
            ...
            >
              ...
              <Chip label={typedAtividades.length} size="small" sx={{ height: 20, fontSize: '0.7rem' }} />
            </ListItem>
          </ListItem>

          {typedGrupos.map((grupo) => (
            <ListItem key={grupo.id} disablePadding>
              ...
              >
                ...
                />
                <Chip label={typedAtividades.filter(a => a.tema_id === grupo.id).length} size="small" sx={{ height: 20, fontSize: '0.7rem', mr: 0.5 }} />
